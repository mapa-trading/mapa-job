from src.apis.busca_dados_brapi import get_crypto_by_sigla, get_moeda_by_sigla, get_cotacao_acao_by_sigla
from src.apis.busca_dados_awesomeapi import get_cotacao_crypto_by_sigla, get_cotacao_moeda_by_sigla
from src.apis.busca_dados_fintz import get_acao_by_sigla
...
def buscar_e_inserir_cotacoes():
    ...
    for acao in ACOES:
        cotacao = get_cotacao_acao_by_sigla(acao)
        inseri_dados_cotacoes(cotacao.toJson())
